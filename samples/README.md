...
Every file in this folder is a valid PDF/PNG/JPEG matching its declared content type, which is all the API (`api/referral/guardrails.py`) requires of an upload.
